<template>
  <view class="wrap-nice-input">
    <view class="wrap-operator wrap-minus">
      <button class="operator cu-btn" :class="isMinusDisabled ? 'disabled' : ''" :disabled="isMinusDisabled" @click="onMinus">-</button>
    </view>
    <view class="wrap-input">
      <input type="text" :style="{ width: widthInput + 'px' }" @input="onInput" :value="inputValue"/>
      <view class="unit" v-if="unit">{{ unit }}</view>
    </view>
    <view class="wrap-operator wrap-plus">
      <button class="operator cu-btn" :class="isPlusDisabled ? 'disabled' : ''" :disabled="isPlusDisabled" @click="onPlus">+</button>
    </view>
  </view>
</template>
