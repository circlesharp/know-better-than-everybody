<template>
	<view>
		...
		<view class="cu-bar bg-white solid-bottom">
			<view class="lines-red ">
				<view class="line-red solid">123</view>按钮形状
			</view>
			<view class="action">
		...
		<view class="padding flex flex-wrap justify-between align-center bg-white">
			...
			<!-- <button class="cu-btn round sm block bg-green margin">小尺寸</button> -->
		...
		<!-- <view class="padding flex flex-direction">
			<button class="cu-btn bg-blue">124</button>
		...
		<!-- <view class="padding">
			<button class="cu-btn bg-blue margin-tb-sm lg" disabled type="">无效状态</button>
